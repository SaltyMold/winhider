...
3. **Standalone Executable**: Run `Firefox.exe` which is included in the installer and portable versions
...
```ahk
; Original hotkey
^+h::RunWait(A_ScriptDir . "\Updater.exe hide " . "ahk_id " . WinExist("A"))
